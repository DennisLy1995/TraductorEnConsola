...
{
    public class ConsultasPalabrasCrudFactory : CrudFactory
    {
        ConsultasPalabrasMapper mapper;

        public ConsultasPalabrasCrudFactory() : base()
        {
            mapper = new ConsultasPalabrasMapper();
            dao = SqlDao.GetInstance();
        }

        public override void Create(BaseEntity entity)
        {
            var consulta = (ConsultasPalabras)entity;
